...
-- ----------------------------
BEGIN;
INSERT INTO `entity` VALUES ('1000', 't_user', 'user', '用户', 'name', '27', null, 'id', null, '', '1'), ('1001', 't_role', 'role', '角色', 'name', '117', null, 'id', null, '', '1'), ('1002', 't_menu', 'menu', '菜单', 'text', '303', '1002', 'id', 'parent_id', '', '1');
COMMIT;
...
CREATE TABLE `entity_operation` (
  ...
  `pagePath` varchar(20) DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `entity_operation` VALUES ('2', '1000', '重置密码', null, '3', '', '', null, 'async function sdsd(record){\n 	const userName = record.user_name;\n    let json = await this.get(`${this.baseUrl}/resetPassword`);\n    if (json.success) {\n      this.notification.info({\n        message: `用户${userName}的密码被重置为123456`,\n      })\n    } else {\n      this.notification.error({\n        message: \'后台错误，请联系管理员\',\n      })\n    }\n}\n'), ('17', '1000', '关联角色', null, '1', null, null, '11', null), ('18', '1001', '菜单权限', null, '1', null, null, '12', null);
COMMIT;
